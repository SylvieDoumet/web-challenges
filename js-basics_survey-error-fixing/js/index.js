...
// 3. This event listener is connected properly. When clicked the button is shown active. However, the debug message doesn't appear in the debug console.
// Where is the error with this code?

const message = "Selected first choice";

console.log(firstChoiceButton, secondChoiceButton);
console.log(message);
...
// Vorschlag : secondChoiceButton.classList.remove ("active-choice") --> .add("active-choice");
...
secondChoiceButton.addEventListener("click", () => {
  ...
  const message = "Selected second choice";
